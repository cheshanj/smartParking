...
public class MainActivity extends Activity {
    ...
    private static final String CLIENT_ID = "b0dedc6444cc401186a0677a978ee932";
    private static final String REDIRECT_URL = "localhost:1234/smartParking/index.html";
        ...
        mWebView.setWebViewClient(new WebViewClient() {
            ...
            public boolean shouldOverrideUrlLoading(WebView view, String uri) {
                if ( uri.startsWith(REDIRECT_URL) ) {
                    // Redirect URL has format localhost:1234/smartParking/index.html#expires_in=1209600&token_type=bearer&access_token=xxxx
    ...
    public String getAuthorizationRequestUri() {
        //https://accounts.artik.cloud/authorize?client=mobile&client_id=xxxx&response_type=token&redirect_uri=http://localhost:1234/smartparking/index.html
